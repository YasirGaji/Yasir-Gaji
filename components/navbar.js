    ...
    >
      <Container display="flex" p={2} maxW="container.md" wrap="wrap" align="center" justify="space-between">
        <Flex align="center" mr={5}>
          <Heading as="h1" size="lg" letterSpacing={'tighter'} fontWeight="normal" color="glassTeal">
            <Logo />
          </Heading>
        </Flex>
        ...
        alignItems="center" flexGrow={1} mt={{ base: 4, nmd: 0 }} >
          ...
          <LinkItem path={path} href="/articles">
            Articles
          </LinkItem>
        </Stack>
          ...
          <Box ml={2} display={{base: 'inline-block', md:'none'}}>
            <Menu>
              ...
              <MenuList>
                ...
                <MenuItem as={Link} href="https://www.pleasantcodes.com">View Source</MenuItem>
              </MenuList>
            </Menu>
          </Box>
        </Box>
